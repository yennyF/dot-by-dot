...
export default function LogHorizontal() {
  ...
  return (
    <HorizontalDragScroll
      ref={contentRef}
      className="app-LogHorizontal scrollbar-none relative mx-[35px] mb-[35px] mt-[70px] max-h-[calc(100dvh-70px-35px)] w-[calc(100dvw-70px)] flex-1 overflow-scroll overscroll-none"
    >
